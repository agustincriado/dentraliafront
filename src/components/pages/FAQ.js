            ...
            <div className="accordion-item">
              ...
              <div id="flush-collapseFive" className="accordion-collapse collapse" aria-labelledby="flush-headingFive" data-bs-parent="#accordionFlushFAQ">
                <div className="accordion-body">
                  <p>Festentradas declara expresamente que por política de empresa no se realizarán cambios ni devoluciones una vez finalizado el proceso de compra, con la única excepción de los casos de cancelación del evento.</p>
                  ...
                  <p>En el caso de que se decida proceder a la devolución del precio de las entradas que adquiridas , será reembolsado por FESTENTRADAS en el mismo medio de pago, dentro del plazo de treinta (30) días hábiles desde la fecha de la comunicación pública de la cancelación.</p>
